...
class Handler extends ExceptionHandler
{
    ...
    public function render($request, Throwable $exception)
    {
        ...
        if ($exception instanceof \ErrorException &&
            ...
            // Create a simple response that clears the cookie and shows error page
            $response = response()->view('errors.token-error', ['message' => 'Your session has expired. Please login again.'], 200);
