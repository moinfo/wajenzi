...
class ServiceDesignApprovalSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $approvableType = 'App\\Models\\ProjectServiceDesign';
        ...
        if ($existingFlow) {
            $this->command->info("Approval flow already exists for ProjectServiceDesign (ID: {$existingFlow->id})");
            return;
        }
        ...
        $this->command->info("Created Service Design Approval flow (ID: {$flowId}).");
    }
}
