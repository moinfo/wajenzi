...
Route::get('/system-overview', function () {
    ...
    return view('pages.system-overview', compact('content'));
...
// Sales Daily Report Routes
    ...
    Route::post('project-schedules/create-for-project/{project}', [App\Http\Controllers\ProjectScheduleController::class, 'createForProject'])->name('projects.schedule.create');
