...
<div class="block-content">
    <form  method="post"  autocomplete="off">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="input-system-name" name="name" value="{{ $object->name ?? '' }}" placeholder="System Name" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            @else
                <button type="submit" class="btn btn-alt-primary col" name="addItem" value="System">Submit</button>
            @endif
        </div>
    </form>
</div>
