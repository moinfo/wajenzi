<?php
$document_id = \App\Classes\Utility::getLastId('BankDeposit')+1;
?>
<div class="block-content">
    <form  method="post"  autocomplete="off">
        ...
        <div class="form-group">
            ...
            <input type="number" step=".01"  class="form-control amount" id="input-amount" name="amount" value="{{ $object->amount ?? '' }}" placeholder="Capital Amount" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            @else
                ...
                <input type="hidden" name="document_type_id" value="17">
                <input type="hidden" name="link" value="bank_deposit/{{$document_id}}/17">
                <button type="submit" class="btn btn-alt-primary col" name="addItem" value="BankDeposit">Submit</button>
            @endif
        </div>
    </form>
</div>
