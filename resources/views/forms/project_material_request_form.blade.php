...
<div class="block-content">
    <form method="post" autocomplete="off">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <select name="status" id="input-status" class="form-control" required="required">
                        ...
                        <option value="rejected" {{ ($object->status == 'rejected') ? 'selected' : '' }}>Rejected</option>
                    </select>
                </div>
            </div>
            <div class="col-sm-4">
        ...
        <div class="form-group">
            ...
            @else
                <button type="submit" class="btn btn-alt-primary col" name="addItem" value="MaterialRequest">Submit</button>
            @endif
        </div>
    </form>
</div>
