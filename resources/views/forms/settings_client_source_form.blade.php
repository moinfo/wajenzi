...
<div class="block-content">
    <form  method="post"  autocomplete="off">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="input-name" name="name" value="{{ $object->name ?? '' }}" placeholder="Source Name" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            @else
                <button type="submit" class="btn btn-alt-primary col" name="addItem" value="ClientSource">Submit</button>
            @endif
        </div>
    </form>
</div>
