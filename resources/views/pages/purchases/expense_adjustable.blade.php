        ...
        <div class="content">
            <div class="content-heading">Adjustment Expenses
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Adjustment Expense"))
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                ...
                                @foreach($adjustable_expenses as $adjustable_expense)
                                    ...
                                    <tr id="adjustable_expense-tr-{{$adjustable_expense->id}}">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Adjustment Expense"))
                                                    <button type="button"
                                                ...
                                                @endif
                                                    ...
                                                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Adjustment Expense"))
                                                        <button type="button"
