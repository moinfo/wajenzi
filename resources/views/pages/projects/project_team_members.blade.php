        ...
        <div class="content">
            <div class="content-heading">Project Team Members
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Team Member"))
                                ...
                                @foreach($teamMembers as $member)
                                    <tr id="member-tr-{{$member->id}}">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Team Member"))
                                                    <button type="button"
                                                ...
                                                @endif
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Team Member"))
                                                    <button type="button"
