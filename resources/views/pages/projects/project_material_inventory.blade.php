                                ...
                                @foreach($inventories as $inventory)
                                    <tr id="inventory-tr-{{$inventory->id}}">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Inventory"))
                                                    <button type="button"
                                                ...
                                                @endif
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Inventory"))
                                                    <button type="button"
