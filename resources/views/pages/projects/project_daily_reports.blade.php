        ...
        <div class="content">
            <div class="content-heading">Daily Reports
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Report"))
                                    ...
                                    <tr id="report-tr-{{$report->id}}">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Report"))
                                                    <button type="button"
                                                ...
                                                @endif
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Report"))
                                                    <button type="button"
