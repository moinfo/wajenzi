        ...
        <div class="content">
            <div class="content-heading">Project Documents
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Document"))
                        <button type="button" onclick="loadFormModal('project_document_form', {className: 'ProjectDocument'}, 'Upload New Document', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10"><i class="si si-plus">&nbsp;</i>New Document</button>
                    @endif
                </div>
            </div>
            <div>
                                    ...
                                    <tr id="document-tr-{{$document->id}}">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Document"))
                                                    <button type="button"
                                                ...
                                                @endif
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Document"))
                                                    <button type="button"
