                                ...
                                @foreach($projectTypes as $type)
                                    <tr id="type-tr-{{$type->id}}">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Project Type"))
                                                    <button type="button"
                                                ...
                                                @endif
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Project Type"))
                                                    <button type="button"
