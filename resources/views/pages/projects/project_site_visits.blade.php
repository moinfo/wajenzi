                                        ...
                                        <div class="row">
                                            <div class="class col-md-3">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" name="start_date" id="start_date" class="form-control datepicker-index-form  datepicker" value="" placeholder="All dates">
                                                </div>
                                            </div>
                                            <div class="class col-md-3">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" name="end_date" id="end_date" class="form-control datepicker-index-form  datepicker" value="" placeholder="All dates">
                                                </div>
                                            </div>
                                            <div class="class col-md-3">
                                                <div class="input-group mb-3">
