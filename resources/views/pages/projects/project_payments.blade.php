        ...
        <div class="content">
            <div class="content-heading">Project Payments
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Payment"))
                        <button type="button" onclick="loadFormModal('project_payment_form', {className: 'ProjectPayment'}, 'Create New Payment', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10"><i class="si si-plus">&nbsp;</i>New Payment</button>
                    @endif
                </div>
            </div>
            <div>
                                ...
                                @foreach($payments as $payment)
                                    <tr id="payment-tr-{{$payment->id}}">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Payment"))
                                                    <button type="button"
                                                ...
                                                @endif
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Payment"))
                                                    <button type="button"
