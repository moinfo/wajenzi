        ...
        <div class="content">
            <div class="content-heading">Receiving
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Receiving"))
                        <button type="button" onclick="loadFormModal('receiving_form', {className: 'Receiving'}, 'Create New Receiving', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10"><i class="si si-plus">&nbsp;</i>New Receiving</button>
                    @endif
                </div>
            </div>
            <div>
                               ...
                               // dump($_GET);
                                ...
                                @foreach($receivings as $receiving)
                                    ...
                                    <tr id="receiving-tr-{{$receiving->id}}">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Receiving"))
                                                    <button type="button"
                                                ...
                                                @endif
                                                    ...
                                                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Receiving"))
                                                        <button type="button"
