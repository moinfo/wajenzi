    ...
    <div class="content">
        <h2 class="content-heading">Recruitment Requests <small>All</small>
            <div class="float-right">
                <button type="button" onclick="loadFormModal('recruitment_form', null, 'modal-lg');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10"><i class="si si-plus">&nbsp;</i>New Recruitment Request</button>
            </div>
        </h2>
        <p>
