            ...
            <div>
                <div class="block block-themed">
                    <div class="block-header bg-wajenzi-gradient">
                        <h3 class="block-title">Annually PAYE Summary Report</h3>
                    </div>
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full" data-ordering="false">
                                ...
                                @foreach ($period as $dt)
                                    @php
                                        ...
                                        $efd_id = null;
                                        $paye = \App\Models\PayrollRecord::getTotalPAYE($start_date,$end_date) ?? 0;
                                        $total_paye += $paye;
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$dt->format("F, Y")}}</td>
                                        <td class="text-right">{{number_format($paye)}}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
                                <tr>
                                    <td>Total</td>
                                    <td class="text-right">{{number_format($total_paye)}}</td>
                                </tr>
                                </tfoot>
                            </table>
                        </div>
