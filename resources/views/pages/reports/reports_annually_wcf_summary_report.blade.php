            ...
            <div>
                <div class="block block-themed">
                    <div class="block-header bg-gd-dusk">
                        <h3 class="block-title">Annually WCF Summary Report</h3>
                    </div>
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full" data-ordering="false">
                                ...
                                @foreach ($period as $dt)
                                    @php
                                        ...
                                        $efd_id = null;
                                        $wcf = \App\Models\PayrollRecord::getTotalWCF($start_date,$end_date) ?? 0;
                                        $total_wcf += $wcf;
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$dt->format("F, Y")}}</td>
                                        <td class="text-right">{{number_format($wcf)}}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
                                <tr>
                                    <td>Total</td>
                                    <td class="text-right">{{number_format($total_wcf)}}</td>
                                </tr>
                                </tfoot>
                            </table>
                        </div>
