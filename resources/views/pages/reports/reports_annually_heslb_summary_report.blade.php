            ...
            <div>
                <div class="block block-themed">
                    <div class="block-header bg-wajenzi-gradient">
                        <h3 class="block-title">Annually HESLB Summary Report</h3>
                    </div>
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full" data-ordering="false">
                                ...
                                @foreach ($period as $dt)
                                    @php
                                        ...
                                        $efd_id = null;
                                        $heslb = \App\Models\PayrollRecord::getTotalHESLB($start_date,$end_date) ?? 0;
                                        $total_heslb += $heslb;
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$dt->format("F, Y")}}</td>
                                        <td class="text-right">{{number_format($heslb)}}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
                                <tr>
                                    <td>Total</td>
                                    <td class="text-right">{{number_format($total_heslb)}}</td>
                                </tr>
                                </tfoot>
                            </table>
                        </div>
