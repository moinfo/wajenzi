                    ...
                    <div class="row no-print m-t-10">
                        <div class="class col-md-12">
                            ...
                            <div class="block-header text-center">
                                <h3 class="block-title">Advance Salary Report</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="block-content">
                        ...
                        <table class="table table-condensed">
                            ...
                            <tr>
                                ...
                                <td width="25%" class="text-right">AD/CONT/{{$payroll_id ?? ''}}</td>
                            </tr>
                            <tr>
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($staffs as $staff)
                                @php
                                    $staff_id = $staff->id;
                                    $net = \App\Models\Staff::getStaffAdvanceSalaryPaid($staff_id,$payroll_id) ?? 0;
                                ...
                                <div class="block block-themed bg-gray min-height-200 text-center" >
                                    <div class="block-content">
                                        <div class="row no-print m-t-10">
                                            <div class="class col-md-12">
                                                <div class="class card-box ">
                                                    <div class='jumbotron '>Failed to get Advance Salary Report for this month!</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
