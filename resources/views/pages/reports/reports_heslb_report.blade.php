                    ...
                    <div class="row no-print m-t-10">
                        <div class="class col-md-12">
                            ...
                            <div class="block-header text-center">
                                <h3 class="block-title">HESLB Report</h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-condensed">
                            ...
                            <tr>
                                ...
                                <td width="50%" class="text-center">
                                    <h2>HIGHER EDUCATION STUDENTS LOARNS BOARD</h2>
                                    <img alt=" " width="180px" src="{{ asset('logo/heslb.png') }}">
                                </td>
                                <td width="25%" class="text-right">
                                    <p>HESLB/CONT/{{$payroll_id}}</p>
                                </td>
                            </tr>
                            <tr>
                        ...
                        @if($payroll)
                            <table class="table table-bordered">
                                ...
                                @foreach($staffs as $staff)
                                    ...
                                    @if($employee_deducted_amount_heslb != 0)
                                        @php
                                            ...
                                            $total_contribution = $employer_deducted_amount_heslb + $employee_deducted_amount_heslb;
                                        ...
                                        <tr>
                                            ...
                                            <td class="money text-right" width="40">15%</td>
                                            <td class="money text-right">{{number_format($employee_deducted_amount_heslb)}}</td>
                                            <td class="money text-right" width="40">0%</td>
                                            <td class="money text-right">{{number_format($employer_deducted_amount_heslb)}}</td>
                                ...
                                <tr>
                                    ...
                                    <th class="money text-right" colspan="2">{{number_format($total_employee_deducted_amount_heslb)}}</th>
                                    <th class="money text-right" colspan="2">{{number_format($total_employer_deducted_amount_heslb)}}</th>
                                ...
                                <div class="block block-themed bg-gray min-height-200 text-center" >
                                    <div class="block-content">
                                        <div class="row no-print m-t-10">
                                            <div class="class col-md-12">
                                                <div class="class card-box ">
                                                    <div class='jumbotron '>Failed to get HESLB Report for this month!</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
