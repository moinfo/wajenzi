            ...
            <div>
                <div class="block block-themed">
                    <div class="block-header bg-wajenzi-gradient">
                        <h3 class="block-title">Annually Allowance Summary Report</h3>
                    </div>
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full" data-ordering="false">
                                ...
                                @foreach ($period as $dt)
                                    @php
                                        ...
                                        $efd_id = null;
                                        $allowance = \App\Models\PayrollRecord::getTotalAllowance($start_date,$end_date) ?? 0;
                                ...
                                <tr>
                                    <td>Total</td>
                                    <td class="text-right">{{number_format($total_allowance)}}</td>
                                </tr>
                                </tfoot>
                            </table>
                        </div>
