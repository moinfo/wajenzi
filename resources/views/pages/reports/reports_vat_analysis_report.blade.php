                    ...
                    <div class="block-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                ...
                                $start_date_last_month = date('Y-m-01', strtotime('last month'));
                                $end_date_last_month = date('Y-m-t', strtotime('last month'));
...
//                                $end_date = $_POST['end_date'] ?? '2021-02-28';
                                ...
                                $last_month_auto_purchases = \App\Models\AutoPurchase::getAutoPurchasesVAT($start_date,$end_date);
                                ...
                                @foreach($last_month_purchases as $purchase)
                                    ...
                                    $total_vats_last_month += $vats_amount;
                                    @endphp
                                @endforeach
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">{{ number_format($total_vat_exempts+$receipt_total_excl_of_tax, 2) }}</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right"></td>
                                    <td class="text-right"></td>
                                    <td class="text-right">{{ number_format(($vat_payable_last_month - ($total_vat_amt_last_month-($total_vats_last_month+$receipt_total_tax_last_month))), 2) }}</td>
                                </tr>
                                <tr>
