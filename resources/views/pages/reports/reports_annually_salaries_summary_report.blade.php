            ...
            <div>
                <div class="block block-themed">
                    <div class="block-header bg-gd-dusk">
                        <h3 class="block-title">Annually Salaries and Wages Summary Report</h3>
                    </div>
                    <div class="block-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full" data-ordering="false">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($period as $dt)
                                        @php
                                            ...
                                            $efd_id = null;
                                            $salaries = \App\Models\PayrollRecord::getTotalBasicSalary($start_date,$end_date) ?? 0;
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$dt->format("F, Y")}}</td>
                                        <td class="text-right">{{number_format($salaries)}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                                <tfoot>
                                <tr>
                                    <td>Total</td>
                                    <td class="text-right">{{number_format($total_salaries)}}</td>
                                </tr>
                                </tfoot>
                            </table>
                        </div>
