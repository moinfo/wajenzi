        ...
        <div class="content">
            <div class="content-heading">Imprest Request
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Imprest Request"))
                ...
                <div class="block block-themed">
                    ...
                    <i class="fa fa-clock-o"></i>{{$group_name ?? null}}
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Imprest Request"))
                                                    <button type="button"
                                                ...
                                                @endif
                                                    ...
                                                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Imprest Request"))
                                                        <button type="button"
