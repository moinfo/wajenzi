        ...
        <div class="content">
            <div class="content-heading">Petty Cash Refill Request
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Petty Cash Refill Request"))
                ...
                <div class="block block-themed">
                    ...
                    <i class="fa fa-clock-o"></i>{{$group_name ?? null}}
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Petty Cash Refill Request"))
                                                    <button type="button"
                                                ...
                                                @endif
                                                    ...
                                                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Petty Cash Refill Request"))
                                                        <button type="button"
