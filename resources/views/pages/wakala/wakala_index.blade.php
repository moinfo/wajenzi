        ...
        <div class="content">
            <div class="content-heading">Wakala
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Wakala"))
                        <button type="button"
                                            ...
                                            @foreach($wakalas as $wakala)
                                                <tr>
                                                    ...
                                                    <td class="text-center" >
                                                        <div class="btn-group">
                                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Wakala"))
                                                            ...
                                                            @endif
                                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Wakala"))
