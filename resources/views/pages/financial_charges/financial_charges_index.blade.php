            ...
            <div class="content-heading">Financial Charges
                <div class="float-right">
                    @can('Add Financial Charge')
                        <button type="button" onclick="loadFormModal('financial_charge_form', {className: 'FinancialCharge'}, 'Create New Financial Charges', 'modal-md');" class="btn btn-rounded min-width-125 mb-10 action-btn add-btn"><i class="si si-plus">&nbsp;</i>New Financial Charges</button>
                    @endcan
                </div>
            </div>
            <div>
