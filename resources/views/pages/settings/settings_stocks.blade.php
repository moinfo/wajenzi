        ...
        <div class="content">
            <div class="content-heading">Settings
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Stock"))
                        <button type="button" onclick="loadFormModal('settings_stock_form', {className: 'Stock'}, 'Create New Stock', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10"><i class="si si-plus">&nbsp;</i>New Stock</button>
                    @endif
                </div>
            </div>
            <div>
                        ...
                        <thead>
                            ...
                            @foreach($stocks as $stock)
                                ...
                                <tr id="stock-tr-{{$stock->id}}">
                                    ...
                                    <td class="text-center" >
                                        <div class="btn-group">
                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Stock"))
                                            ...
                                            @endif
                                                ...
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Stock"))
