                ...
                <div class="block">
                    ...
                    <div class="block-content tab-content">
                        ...
                        <div class="tab-pane" id="btabs-alt-static-subscription" role="tabpanel">
                            ...
                            <br/>
                            <div class="float-right">
                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Allowance Subscription"))
                                    <button type="button" onclick="loadFormModal('settings_allowance_subscriptions_form', {className: 'AllowanceSubscription'}, 'Create New AllowanceSubscription', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10">
                                        <i class="si si-plus">&nbsp;</i>New AllowanceSubscription</button>@endif
                                        ...
                                        @foreach($staffs as $staff)
                                            ...
                                            @foreach($staff->allowance_subscriptions as $allowance_subscription)
                                                ...
                                                <tr id="staff-tr-{{$allowance_subscription->id}}">
                                                    ...
                                                    <td class="text-center" >
                                                        <div class="btn-group">
                                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Allowance Subscription"))
                                                            ...
                                                            @endif
                                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Allowance Subscription"))
...
{{--                                        </tfoot>--}}
                        ...
                        <div class="tab-pane" id="btabs-alt-static-payments" role="tabpanel">
                            ...
                            <div class="float-right">
                                ...
                                ?>
                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Allowance Payment"))
                                    <button type="button" onclick="loadFormModal('settings_allowance_payment_form', {className: 'AllowancePayment'}, 'Create New Allowance Payment', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10">
                                        <i class="si si-plus">&nbsp;</i>New Allowance Payment</button> @endif
                                <?php
                                }
                                }
                                ?>
                                    ...
                                    <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                        ...
                                        @foreach($allowance_payments as $allowance_payment)
                                            ...
                                            <tr id="allowance_payment-tr-{{$allowance_payment->id}}">
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Allowance Payment"))
                                                        ...
                                                        @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Allowance Payment"))
...
{{--                                                                    <option value="">Select Month</option>--}}
                        ...
                        <div class="tab-pane" id="btabs-alt-static-settings" role="tabpanel">
                            <div class="tab-pane active" id="btabs-alt-static-allocate" role="tabpanel">
                                ...
                                <br/>
                                <div class="float-right">
                                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Deduction Setting"))
                                        ...
                                        <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                            ...
                                            @foreach($deduction_settings as $deduction_setting)
                                                <tr id="deduction_setting-tr-{{$deduction_setting->id}}">
                                                    ...
                                                    <td class="text-center" >
                                                        <div class="btn-group">
                                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Deduction Setting"))
                                                            ...
                                                            @endif
                                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Deduction Setting"))
