        ...
        <div class="content">
            <div class="content-heading">Settings
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Chart Account Variable"))
                        <button type="button" onclick="loadFormModal('settings_chart_account_variable_form', {className: 'ChartAccountVariable'}, 'Create New Chart Account Variable', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10">
                            <i class="si si-plus">&nbsp;</i>New Chart Account Variable</button>@endif
                        ...
                        <thead>
                            ...
                            @foreach($chart_account_variables as $chart_account_variable)
                                <tr id="chart_account_variable-tr-{{$chart_account_variable->id}}">
                                    ...
                                    <td class="text-center" >
                                        <div class="btn-group">
                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Chart Account Variable"))
                                            ...
                                            @endif
                                                ...
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Chart Account Variable"))
