            ...
            <div class="content-heading">Settings
                <div class="float-right">
                    @can('Add Chart Account')
                        <button type="button" onclick="loadFormModal('settings_chart_of_account_form', {className: 'ChartAccount'}, 'Create New Chart Account', 'modal-md');" class="btn btn-rounded min-width-125 mb-10 action-btn add-btn">
