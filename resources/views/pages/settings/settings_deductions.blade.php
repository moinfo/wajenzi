        ...
        <div class="content">
            <div class="content-heading">Settings
                <div class="float-right">
                    @can('Add Deduction')
                        <button type="button" onclick="loadFormModal('settings_deduction_form', {className: 'Deduction'}, 'Create New Deduction', 'modal-md');" class="btn btn-rounded min-width-125 mb-10 action-btn add-btn">
                            <i class="si si-plus">&nbsp;</i>New Deduction</button>@endcan
