        ...
        <div class="content">
            <div class="content-heading">Settings
                <div class="float-right">
                    @can('Add Bank')
                        <button type="button" onclick="loadFormModal('settings_bank_form', {className: 'Bank'}, 'Create New Bank', 'modal-md');" class="btn btn-rounded min-width-125 mb-10 action-btn add-btn">
