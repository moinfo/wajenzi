        ...
        <div class="content">
            <div class="content-heading">Settings
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Statutory Payment"))
                        <button type="button" onclick="loadFormModal('settings_statutory_payment_form', {className: 'StatutoryPayment'}, 'Create New Statutory Payment', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10">
                            <i class="si si-plus">&nbsp;</i>New Statutory Payment</button> @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" >
                                        <div class="btn-group">
                                            ...
                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Statutory Payment"))
