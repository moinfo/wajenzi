        ...
        <div class="content">
            <div class="content-heading">Settings
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Account Type"))
                        <button type="button" onclick="loadFormModal('settings_account_type_form', {className: 'AccountType'}, 'Create New Account Type', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10">
                            <i class="si si-plus">&nbsp;</i>New Account Type</button>@endif
                                    ...
                                    <td class="text-center" >
                                        <div class="btn-group">
                                            ...
                                            @endif
                                                ...
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Account Type"))
