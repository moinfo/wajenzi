        ...
        <div class="content">
            <div class="content-heading">Leave Types
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Leave Type"))
                        <button type="button" onclick="loadFormModal('settings_leave_type_form', {className: 'LeaveType'}, 'Create New LeaveType', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10"><i class="si si-plus">&nbsp;</i>New Leave Type</button>
                    @endif
                </div>
            </div>
            <div>
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                            ...
                            @foreach($leave_types as $leave_type)
                                <tr id="leave_type-tr-{{$leave_type->id}}">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Leave Type"))
                                            ...
                                            @endif
                                                ...
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Leave Type"))
