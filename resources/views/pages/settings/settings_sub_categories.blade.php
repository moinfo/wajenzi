        ...
        <div class="content">
            <div class="content-heading">Settings
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Statutory Payment Sub Category"))
                        <button type="button" onclick="loadFormModal('settings_sub_category_form', {className: 'SubCategory'}, 'Create New Sub Category', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10">
                            <i class="si si-plus">&nbsp;</i>New Sub Category</button> @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" >
                                        <div class="btn-group">
                                            ...
                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Statutory Payment Sub Category"))
