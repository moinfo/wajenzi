        ...
        <div class="content">
            <div class="content-heading">EXPENSES SUB CATEGORIES
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Expenses Sub Category"))
                        <button type="button" onclick="loadFormModal('settings_expenses_sub_category_form', {className: 'ExpensesSubCategory'}, 'Create New Expense Category', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10"><i class="si si-plus">&nbsp;</i>New Expense Category</button>
                    @endif
                </div>
            </div>
            <div>
                                    ...
                                    <td class="text-center" >
                                        <div class="btn-group">
                                            ...
                                            @endif
                                                ...
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Expenses Sub Category"))
