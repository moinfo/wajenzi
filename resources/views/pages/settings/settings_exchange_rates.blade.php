        ...
        <div class="content">
            <div class="content-heading">Settings
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Exchange Rate"))
                        <button type="button" onclick="loadFormModal('settings_exchange_rate_form', {className: 'ExchangeRate'}, 'Create New Exchange Rate', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10">
                            <i class="si si-plus">&nbsp;</i>New Exchange Rate</button>@endif
                        ...
                        <thead>
                            ...
                            @foreach($exchange_rates as $exchange_rate)
                                <tr id="exchange_rate-tr-{{$exchange_rate->id}}">
                                    ...
                                    <td class="text-center" >
                                        <div class="btn-group">
                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Exchange Rate"))
                                            ...
                                            @endif
                                                ...
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Exchange Rate"))
