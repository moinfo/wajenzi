        ...
        <div class="content">
            <div class="content-heading">Activities
                <div class="float-right">
                    @can('Add Activity')
                        <button type="button" onclick="loadFormModal('settings_activity_form', {className: 'Activity'}, 'Create New Activity', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10">
