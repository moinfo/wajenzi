            ...
            <div class="content-heading">Settings
                <div class="float-right">
                    @can('Add Statutory Payment Category')
                        <button type="button" onclick="loadFormModal('settings_category_form', {className: 'Category'}, 'Create New Category', 'modal-md');" class="btn btn-rounded min-width-125 mb-10 action-btn add-btn">
