        ...
        <div class="content">
            <div class="content-heading">Settings
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Approval Document Type"))
                        <button type="button" onclick="loadFormModal('settings_approval_document_type_form', {className: 'ApprovalDocumentType'}, 'Create New Approval Document Type', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10">
                            <i class="si si-plus">&nbsp;</i>New Approval Document Type</button> @endif
                            ...
                            @foreach ($approval_document_types as $key => $value)
                                <tr>
                                    ...
                                    <td class="text-center" >
                                        <div class="btn-group">
                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Approval Document Type"))
                                            ...
                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Approval Document Type"))
