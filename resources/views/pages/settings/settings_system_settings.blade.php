            ...
            <div class="content-heading">Settings
                <div class="float-right">
                    @can('Add System Setting')
                        <button type="button" onclick="loadFormModal('system_setting_form', {className: 'SystemSetting'}, 'Create New SystemSetting', 'modal-md');" class="btn btn-rounded min-width-125 mb-10 action-btn add-btn">
