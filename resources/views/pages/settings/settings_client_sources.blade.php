        ...
        <div class="content">
            <div class="content-heading">Settings
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Client Source"))
                        <button type="button" onclick="loadFormModal('settings_client_source_form', {className: 'ClientSource'}, 'Create New ClientSource', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10">
                        ...
                        <thead>
                            ...
                            @foreach($client_sources as $client_source)
                                <tr id="client_source-tr-{{$client_source->id}}">
                                    ...
                                    <td class="text-center" >
                                        <div class="btn-group">
                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Client Source"))
                                            ...
                                            @endif
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Client Source"))
