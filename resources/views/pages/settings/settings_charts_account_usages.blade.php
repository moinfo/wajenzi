        ...
        <div class="content">
            <div class="content-heading">Settings
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Charts Account Usage"))
                        <button type="button" onclick="loadFormModal('settings_charts_account_usage_form', {className: 'ChartAccountUsage'}, 'Create New Charts Account Usage', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-125 mb-10">
                            <i class="si si-plus">&nbsp;</i>New Charts Account Usage</button>@endif
                                    ...
                                    <td class="text-center" >
                                        <div class="btn-group">
                                            ...
                                            @endif
                                                ...
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Charts Account Usage"))
