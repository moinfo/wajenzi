            ...
            <div>
                <div class="block">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Unrepresented Slip</h3>
                    </div>
                    <div class="block-content">
                        @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Date Unrepresented Slip"))
                            <div class="row no-print m-t-10">
                                <div class="class col-md-12">
                                    <div class="class card-box">
                                        <form  name="collection_search" action="{{route('unrepresented_slip')}}" id="filter-form" method="post" autocomplete="off">
                                            @csrf
                                            <div class="row">
...
{{--                                                    <td class="font-w600">{{ $bank_reconciliation->description }}</td>--}}
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Unrepresented Slip"))
                                                                <button type="button"
                                                                        onclick="loadFormModal('unrepresented_slip_form', {className: 'BankReconciliation', id: {{$bank_reconciliation->id}}}, 'Edit {{$bank_reconciliation->efd}}', 'modal-md');"
