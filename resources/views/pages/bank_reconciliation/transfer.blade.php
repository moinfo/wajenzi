        ...
        <div class="content">
            <div class="content-heading">Bank Reconciliation
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Bank Transfer"))
            ...
            <div>
                <div class="block">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">BanK Transfer</h3>
                    </div>
                    <div class="block-content">
                        @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Date Bank Transfer"))
                            <div class="row no-print m-t-10">
                                <div class="class col-md-12">
                                    <div class="class card-box">
                                        <form  name="collection_search" action="{{route('bank_reconciliation_transfers')}}" id="filter-form" method="post" autocomplete="off">
                                            @csrf
                                            <div class="row">
                                        ...
                                        <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                            ...
                                            @foreach($bank_reconciliations as $bank_reconciliation)
                                                ...
                                                <tr id="bank_reconciliation-tr-{{$bank_reconciliation->id}}">
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Bank Transfer"))
                                                                <button type="button"
                                                            ...
                                                            @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Bank Transfer"))
                                                                <button type="button"
