        ...
        <div class="content">
            <div class="content-heading">Bank Reconciliation
                <div class="float-right">
                    @can('Add Bank Withdraw')
                        <button type="button" title="Withdraw" onclick="loadFormModal('bank_reconciliation_withdraw_form', {className: 'BankReconciliation'}, 'Create New Withdraw', 'modal-md');" class="btn btn-rounded btn-outline-primary min-width-100 mb-10"><i class="si si-plus">&nbsp;</i>New Withdraw</button>
                    @endcan
            ...
            <div>
                <div class="block">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">BanK Withdraw</h3>
                    </div>
                    <div class="block-content">
                        @can('Date Bank Withdraw')
                            <div class="row no-print m-t-10">
                                <div class="class col-md-12">
                                    <div class="class card-box">
                                        <form  name="collection_search" action="{{route('bank_reconciliation_withdraws')}}" id="filter-form" method="post" autocomplete="off">
                                            @csrf
                                            <div class="row">
