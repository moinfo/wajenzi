                        ...
                        <thead>
                            ...
                            @foreach($staff_bank_details as $staff_bank_detail)
                                <tr id="staff_bank_detail-tr-{{$staff_bank_detail->id}}">
                                    ...
                                    <td class="text-center" >
                                        <div class="btn-group">
                                        @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Staff Bank Detail"))
                                            ...
                                            @endif
                                                ...
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Staff Bank Detail"))
