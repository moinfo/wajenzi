                                ...
                                <tr id="staff_bank_detail-tr-{{$staff_bank_detail->id}}">
                                    ...
                                    <td class="text-center" >
                                        ...
                                        @can('Edit Staff Bank Detail')
                                                <button type="button" onclick="loadFormModal('settings_staff_bank_detail_form', {className: 'StaffBankDetail', id: {{$staff_bank_detail->id}}}, 'Edit {{$staff_bank_detail->staff->name ?? "Staff"}}', 'modal-md');" class="btn btn-sm btn-primary js-tooltip-enabled" data-toggle="tooltip" title="Edit" data-original-title="Edit">
