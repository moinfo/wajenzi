        ...
        <div class="content">
            <div class="content-heading">Settings
                ...
                <div class="float-right">
                    @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Add Adjustment"))
                        ...
                        <thead>
                            ...
                            @foreach($adjustments as $adjustment)
                                <tr id="adjustment-tr-{{$adjustment->id}}">
                                    ...
                                    <td class="text-center" >
                                        <div class="btn-group">
                                        @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Edit Adjustment"))
                                            ...
                                            @endif
                                                ...
                                                @if(\App\Models\UsersPermission::isUserAllowed(Auth::user()->id,"CRUD","Delete Adjustment"))
