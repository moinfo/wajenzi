...
<div class="container-fluid">
    <div class="content">
        <div class="content-heading">Service Design Dashboard
            <div class="float-right">
                ...
                <button type="button" data-toggle="modal" data-target="#createModal"
                    ...
                    <i class="si si-plus">&nbsp;</i>New Service Design
                </button>
                @endif
            </div>
        </div>
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">All Service Designs</h3>
            </div>
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('service_design.show', $design) }}"
                        ...
                        @empty
                        <tr>
                            <td colspan="8" class="text-center text-muted">No service designs found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
...
<div class="modal fade" id="createModal" tabindex="-1">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="{{ route('service_design.store') }}" method="POST">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title">Create Service Design</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="assigned_engineer_id" class="form-control">
                            ...
                            @foreach(\App\Models\User::whereHas('roles', fn($q) => $q->where('name','Service Engineer'))->get() as $u)
