    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: asyncData.when(
          loading: () => const LoadingWidget(message: 'Loading project statuses...'),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 8),
                        const Text(
                          'Create a project status to match the web settings page.',
                          textAlign: TextAlign.center,
                        ),
                        ...
                        ElevatedButton.icon(
                          onPressed: () => _openForm(context, ref),
                          icon: const Icon(Icons.add),
                          label: const Text('New Project Status'),
                        ),
                      ],
                    ),
                  ),
  ...
  Future<void> _deleteItem(
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) => AlertDialog(
        title: const Text('Delete Project Status'),
    ...
    try {
      await ref.read(apiClientProvider).delete('/project-statuses/${item['id']}');
      ref.invalidate(_projectStatusesProvider);
      if (!context.mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Project status deleted successfully'),
...
class _ProjectStatusFormSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_ProjectStatusFormSheet> createState() => _ProjectStatusFormSheetState();
}

class _ProjectStatusFormSheetState extends ConsumerState<_ProjectStatusFormSheet> {
          ...
          child: Form(
            ...
            child: ListView(
              children: [
                ...
                const SizedBox(height: 16),
                Text(
                  _isEdit ? 'Edit Project Status' : 'Create New Project Status',
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      _submitting
                          ? 'Saving...'
                          : (_isEdit ? 'Update Project Status' : 'Save Project Status'),
                    ),
                  ),
                ),
              ],
