...
class ExpensesCategoriesScreen extends ConsumerWidget {
  const ExpensesCategoriesScreen({super.key});
  ...
  Future<void> _openForm(
    ...
    final result = await showModalBottomSheet<bool>(
      ...
      builder: (_) => FractionallySizedBox(
        heightFactor: 0.52,
        child: _ExpenseCategoryFormSheet(item: item),
      ),
    );
    if (result == true) {
      ref.invalidate(_expensesCategoriesProvider);
  ...
  Future<void> _deleteItem(
    ...
    try {
      await ref
          ...
          .delete('/expenses-categories/${item['id']}');
      ref.invalidate(_expensesCategoriesProvider);
...
class _ExpenseCategoryFormSheet extends ConsumerStatefulWidget {
  final Map<String, dynamic>? item;

  const _ExpenseCategoryFormSheet({this.item});

  @override
  ConsumerState<_ExpenseCategoryFormSheet> createState() =>
      _ExpenseCategoryFormSheetState();
}

class _ExpenseCategoryFormSheetState
    extends ConsumerState<_ExpenseCategoryFormSheet> {
