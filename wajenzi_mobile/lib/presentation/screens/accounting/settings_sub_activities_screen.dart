...
class _SettingsSubActivitiesScreenState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: subActivitiesAsync.maybeWhen(
          ...
          slivers: [
            ...
            subActivitiesAsync.when(
              ...
              data: (payload) {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              isSwahili
                                  ? 'Sub-Activities haipatikani kwenye live API kwa sasa.'
                                  : 'Sub-Activities is not available on the live API right now.',
                ...
                final subActivities = (payload['items'] as List)
